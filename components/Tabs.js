...
var Tabs = React.createClass({
  ...
  render: function render() {
    ...
    for (var i = 0, l = children.length; i < l; i++) {
      ...
      var tabTitleStyles = [styles.tabTitleStyle, ReactStyle({ width: 100 / children.length + "%" })];
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        titles,
        React.createElement("div", { styles: [styles.selectionBarStyle, ReactStyle({
  ...
  onTabHeaderClick: function onTabHeaderClick(e) {
    var props = this.props;
    if (props.onChange) {
      var position = 0;
      var target = e.target;

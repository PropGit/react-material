...
var TextField = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement("div", { styles: [scrollLeft ? ReactStyle({ opacity: "1" }) : null, this.state.focus ? styles.focusStyle : null, styles.scrollBlocksStyle, ReactStyle({ left: "6px" })] }),
      React.createElement("div", { styles: [scrollWidth > scrollLeft + width ? ReactStyle({ opacity: "1" }) : null, this.state.focus ? styles.focusStyle : null, styles.scrollBlocksStyle, ReactStyle({ right: "6px" })] })
    );
  },
